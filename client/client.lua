        ...
        if not IsPauseMenuActive() then
            ...
            if IsPedInAnyVehicle(ped) then
                ...
                SendNUIMessage({
                    ...
                    seatbelt = (LocalPlayer.state.seatbelt or LocalPlayer.state.harness) and true or false,
                    sirens = (GetPedInVehicleSeat(vehicle, -1) == ped) and IsVehicleSirenOn(vehicle) or false,
                })
            else
...
RegisterNetEvent("hud:client:LoadMap", function()
    ...
    SetMinimapComponentPosition('minimap', 'L', 'B', 0.0 + minimapOffset, -0.015, 0.1638, 0.219)
    SetMinimapComponentPosition('minimap_mask', 'L', 'B', 0.05 + minimapOffset, 0.04, 0.128, 0.20)
